...
* {{< ghlink href="examples/xonotic" >}}Xonotic{{< /ghlink >}} - Wraps the SDK around the open source FPS game
  [Xonotic](http://www.xonotic.org) and hosts it on Code Blind.
* {{< ghlink href="examples/supertuxkart" >}}SuperTuxKart{{< /ghlink >}} \- Wraps the SDK around the open source
  racing game [SuperTuxKart](https://supertuxkart.net/), and hosts it on Code Blind.

## Building on top of Code Blind

- {{< ghlink href="examples/crd-client" >}}Code Blind API Usage Example{{< /ghlink >}} (Go) -
  This service provides an example of using the [Code Blind API](https://pkg.go.dev/agones.dev/agones/pkg/client/clientset/versioned/typed/agones/v1)
  to create a GameServer.

## Game Server Allocation

- {{< ghlink href="examples/allocation-endpoint" >}}Allocation Endpoint Example{{< /ghlink >}} - An Code Blind clusters 
  aware proxy, built on Google Cloud.

## Integrations with other projects

* [googleforgames/space-agon](https://github.com/googleforgames/space-agon) - Space Agon is a demo of Code Blind and 
  Open Match with a browser based game.
* [googleforgames/global-multiplayer-demo](https://github.com/googleforgames/global-multiplayer-demo) - A demo of a global scale multiplayer game using Code Blind, Open Match, Unreal Engine 5 and multiple Google Cloud products.
