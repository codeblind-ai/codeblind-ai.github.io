---
title: "Install Code Blind using Helm"
linkTitle: "Helm"
weight: 20
description: >
  Install Code Blind on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
---
...
_We recommend installing Code Blind in its own namespaces, such as `agones-system` as shown above.
...
pool for Code Blind, see the [Code Blind installation instructions]({{< relref "../_index.md" >}}) for your preferred environment.

The command deploys Code Blind on the Kubernetes cluster with the default configuration. The [configuration](#configuration) section lists the parameters that can be configured during installation.
...
| `agones.serviceaccount.controller.annotations`           | [Annotations][annotations] added to the Code Blind controller service account                                                                                                                                                                                                                                        | `{}`                                      |
| `agones.serviceaccount.sdk.name`                         | Service account name for the sdk                                                                                                                                                                                                                                                                                 | `agones-sdk`                              |
| `agones.serviceaccount.sdk.annotations`                  | A map of namespaces to maps of [Annotations][annotations] added to the Code Blind SDK service account for the specified namespaces                                                                                                                                                                                   | `{}`                                      |
| `agones.serviceaccount.allocator.name`                   | Service account name for the allocator                                                                                                                                                                                                                                                                           | `agones-allocator`                        |
| `agones.serviceaccount.allocator.annotations`            | [Annotations][annotations] added to the Code Blind allocator service account                                                                                                                                                                                                                                         | `{}`                                      |
...
| `agones.controller.annotations`                          | [Annotations][annotations] added to the Code Blind controller pods                                                                                                                                                                                                                                                   | `{}`                                      |
...
| `agones.controller.allocationApiService.annotations`     | [Annotations][annotations] added to the Code Blind apiregistration                                                                                                                                                                                                                                                   | `{}`                                      |
| `agones.controller.allocationApiService.disableCaBundle` | Disable ca-bundle so it can be injected by cert-manager                                                                                                                                                                                                                                                          | `false`                                   |
| `agones.controller.validatingWebhook.annotations`        | [Annotations][annotations] added to the Code Blind validating webhook                                                                                                                                                                                                                                                | `{}`                                      |
| `agones.controller.validatingWebhook.disableCaBundle`    | Disable ca-bundle so it can be injected by cert-manager                                                                                                                                                                                                                                                          | `false`                                   |
| `agones.controller.mutatingWebhook.annotations`          | [Annotations][annotations] added to the Code Blind mutating webhook                                                                                                                                                                                                                                                  | `{}`                                      |
...
| `agones.ping.http.annotations`                           | [Annotations][annotations] added to the Code Blind ping http service                                                                                                                                                                                                                                                 | `{}`                                      |
...
| `agones.ping.udp.annotations`                            | [Annotations][annotations] added to the Code Blind ping udp service                                                                                                                                                                                                                                                  | `{}`                                      |
...
| `agones.ping.annotations`                                | [Annotations][annotations] added to the Code Blind ping pods                                                                                                                                                                                                                                                         | `{}`                                      |
...
| `agones.allocator.service.clusterIP`                     | The [Cluster IP][clusterIP] of the Code Blind allocator. If you want [Headless Service][headless-service] for Code Blind Allocator, you can set `None` to clusterIP.                                                                                                                                                     | \`\`                                      |
| `agones.allocator.service.loadBalancerIP`                | The [Load Balancer IP][loadBalancer] of the Code Blind allocator load balancer. Only works if the Kubernetes provider supports this option.                                                                                                                                                                          | \`\`                                      |
| `agones.allocator.service.loadBalancerSourceRanges`      | The [Load Balancer SourceRanges][loadBalancer] of the Code Blind allocator load balancer. Only works if the Kubernetes provider supports this option.                                                                                                                                                                | `[]`                                      |
| `agones.allocator.service.annotations`                   | [Annotations][annotations] added to the Code Blind allocator service                                                                                                                                                                                                                                                 | `{}`                                      |
...
| `agones.allocator.annotations`                           | [Annotations][annotations] added to the Code Blind allocator pods                                                                                                                                                                                                                                                    | `{}`                                      |
| `agones.allocator.resources`                             | Allocator pods [resource requests/limit][resources]                                                                                                                                                                                                                                                              | `{}`                                      |
| `agones.allocator.labels`                                | [Labels][labels] Added to the Code Blind Allocator pods                                                                                                                                                                                                                                                              | `{}`                                      |
...
| `agones.allocator.serviceMetrics.annotations`            | [Annotations][annotations] added to the Code Blind allocator second Service                                                                                                                                                                                                                                          | `{}`                                      |
...
| `agones.extensions.annotations`                          | [Annotations][annotations] added to the Code Blind extensions pods                                                                                                                                                                                                                                                   | `{}`                                      |
...
| `agones.extensions.allocationApiService.annotations`     | [Annotations][annotations] added to the Code Blind apiregistration                                                                                                                                                                                                                                                   | `{}`                                      |
| `agones.extensions.allocationApiService.disableCaBundle` | Disable ca-bundle so it can be injected by cert-manager                                                                                                                                                                                                                                                          | `false`                                   |
| `agones.extensions.validatingWebhook.annotations`        | [Annotations][annotations] added to the Code Blind validating webhook                                                                                                                                                                                                                                                | `{}`                                      |
| `agones.extensions.validatingWebhook.disableCaBundle`    | Disable ca-bundle so it can be injected by cert-manager                                                                                                                                                                                                                                                          | `false`                                   |
| `agones.extensions.mutatingWebhook.annotations`          | [Annotations][annotations] added to the Code Blind mutating webhook                                                                                                                                                                                                                                                  | `{}`                                      |
