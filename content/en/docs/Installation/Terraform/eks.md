---
title: "Installing Code Blind on AWS Elastic Kubernetes Service using Terraform"
linkTitle: "AWS"
weight: 20
...
An example of the EKS submodule config file can be found here:
 {{< ghlink href="examples/terraform-submodules/eks/module.tf" >}}Terraform configuration with Code Blind submodule{{< /ghlink >}}
