...
weight: 20
description: "This is the C++ version of the Code Blind Game Server Client SDK. "
---
...
Code Blind SDK only depends on the [gRPC](https://grpc.io/) library.

{{< feature publishVersion="1.39.0" >}}
{{< alert title="Warning" color="warning" >}}
Prior to Code Blind release 1.39.0 if the gRPC dependency was not found locally installed, the CMake system would install
...
{{% feature publishVersion="1.39.0" %}}
This version of the Code Blind C++ SDK has been tested with gRPC 1.57.1. To install it from source 
...
- **AGONES_OPENSSL_CONFIG_STRING** (default is VC-WIN64A) - arguments to configure OpenSSL build ([documentation](https://github.com/openssl/openssl/blob/OpenSSL_1_1_1-stable/INSTALL)). Used only if OpenSSL and gRPC is built by Code Blind.
